...
namespace Repo_EF.Migrations
{
    ...
    [Migration("20230528171428_Add url in Images Table")]
    partial class AddurlinImagesTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repo_Core.Models.RoverImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlanResultId", "PlanSequenceNumber", "PlanId");

                    b.ToTable("RoverImages");
                });
            ...
            modelBuilder.Entity("Repo_Core.Models.RoverImage", b =>
                {
                    b.HasOne("Repo_Core.Models.PlanResult", "PlanResult")
                        .WithMany("RoverImages")
                        .HasForeignKey("PlanResultId", "PlanSequenceNumber", "PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlanResult");
                });
